...
QT_MOC_LITERAL(1, 16, 11), // "sendToInput"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "ResourceManager\0sendToInput\0"
};
...
void ResourceManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendToInput((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (ResourceManager::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ResourceManager::sendToInput)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ResourceManager::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_ResourceManager.data,
...
// SIGNAL 0
void ResourceManager::sendToInput(QString _t1, QString _t2)
{
